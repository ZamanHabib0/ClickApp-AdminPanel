...
import { deleteCustomer } from 'api/membershupNumber';
...
export default function AlertCustomerDelete({ id, title, open, handleClose }) {
  ...
  const deletehandler = async () => {
    await deleteCustomer(id).then(() => {
      openSnackbar({
        open: true,
        message: 'Membership number deleted successfully',
        ...
        <Stack alignItems="center" spacing={3.5}>
          ...
          <Stack spacing={2}>
            ...
            <Typography align="center">
              ...
              Membership Number, all task assigned to that Membership Number will also be deleted.
            </Typography>
          </Stack>
