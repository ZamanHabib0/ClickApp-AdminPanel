...
// project imports
import AlertCustomerDelete from './AlertServiceDelete';
...
import { insertCustomer, updateCustomer } from 'api/avaliableService';
...
export default function FormCategoryAdd({ customer, closeModal  }) {
    ...
    const CustomerSchema = Yup.object().shape({
        serviceName: Yup.string().max(255).required('Service Name is required'),
        image: Yup.mixed()
    ...
    return (
        <>
            <FormikProvider value={formik}>
                <LocalizationProvider dateAdapter={AdapterDateFns}>
                    <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
                        <DialogTitle>{customer ? 'Edit Service' : 'New Service'}</DialogTitle>
                        <Divider />
                                ...
                                <Grid item xs={12} md={8}>
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={12}>
                                            <Stack spacing={1}>
                                                <InputLabel htmlFor="customer-firstName">Service Name</InputLabel>
                                                <TextField
                                                    fullWidth
                                                    id="name"
            ...
            {customer && <AlertCustomerDelete id={customer._id} title={customer.serviceName} open={openAlert} handleClose={handleAlertClose} />}
        </>
    );
}
