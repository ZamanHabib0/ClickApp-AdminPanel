...
//asset
import WelcomeImage from 'assets/simple_logo.png';
      ...
      <Grid container>
        <Grid item md={6} sm={6} xs={12}>
          <Stack spacing={2} sx={{ padding: 3 }}>
            ...
            Discover unbeatable deals from your favorite brands
            </Typography>
            <Typography variant="h6" color={theme.palette.background.paper}>
            Unlock amazing offers and save big with Click App – your gateway to exclusive deals from top brands.
            </Typography>
