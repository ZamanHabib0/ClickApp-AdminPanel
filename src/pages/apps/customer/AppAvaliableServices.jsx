...
import CategoryModal from 'sections/apps/customer/AvaliableService';
import AlertCustomerDelete from 'sections/apps/customer/AlertServiceDelete';
...
import { useGetCustomer, insertCustomer, updateCustomer, deleteCustomer } from 'api/avaliableService';
            ...
            <Tooltip title="Delete">
              <IconButton
                ...
                onClick={(e) => {
                  ...
                  setCustomerTitle(row.original.serviceName);
                  handleClose();
                }}
              >
                <Trash />
